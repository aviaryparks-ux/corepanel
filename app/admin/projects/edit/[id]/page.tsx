// app/admin/projects/edit/[id]/page.tsx - SIMPLE
"use client";
...
export default function EditProjectPage() {
  ...
  const [form, setForm] = useState({ name: "", type: "Mobile APK", client: "", description: "", image: "", tech: "", year: "", link: "" });
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" value={form.tech} onChange={e => setForm({ ...form, tech: e.target.value })} className="w-full border rounded px-3 py-2 mt-1" />
            </div>
            <div>
          ...
          <div>
            ...
            <input type="text" value={form.image} onChange={e => setForm({ ...form, image: e.target.value })} className="w-full border rounded px-3 py-2 mt-1" />
          </div>
